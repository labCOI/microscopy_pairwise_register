    ...
    for i = 1:nb_vert_tiles
        ...
        if i > 1
            ...
            [mainn.Ty_north(i,j), mainn.Tx_north(i,j), mainn.index_ImMatch_north(i,j), mainn.matchedNumb_north(i,j),...
                ...
                mainn.inlierPoints_north{i,j}, mainn.inlierPointsPrev_north{i,j}] = compute_trasnform(feature_function,I1, I2, index_matrix(i,j), Threshold_metric);
        end
        if j > 1
            % perform pciam west
            if channel == 3
            ...
            [mainn.Ty_west(i,j), mainn.Tx_west(i,j), mainn.index_ImMatch_west(i,j),mainn.matchedNumb_west(i,j),...
                ...
                mainn.inlierPoints_west{i,j}, mainn.inlierPointsPrev_west{i,j}] = compute_trasnform(feature_function,I1, I2, index_matrix(i,j), Threshold_metric);
        end
    end
end
