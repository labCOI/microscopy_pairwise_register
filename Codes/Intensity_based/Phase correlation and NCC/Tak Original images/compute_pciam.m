...
function [t_Y1, t_X1, t_Y2, t_X2, CC1, CC2, M, N] = compute_pciam(source_directory, img_name_grid, log_file_path)
startTime = tic;
 ...
 for i = 1:nb_vertical_tiles
    ...
    if i > 1
      ...
      I2 = read_img(source_directory, img_name_grid{i-1,j});
       I2 =rgb2gray(I2);
      [t_Y1(i,j), t_X1(i,j), CC1(i,j)] = pciam(I2, I1, StitchingConstants.NORTH,NB_FFT_PEAKS, 0);
    ...
    if j > 1
      ...
      I2 = read_img(source_directory, img_name_grid{i,j-1});
       I2 =rgb2gray(I2);
      [t_Y2(i,j), t_X2(i,j), CC2(i,j)] = pciam(I2, I1, StitchingConstants.WEST, NB_FFT_PEAKS, 0);
    end
  end
end
  
 I1 = read_img(source_directory, img_name_grid{1,1});
  I1 =rgb2gray(I1);
    [M N]= size(I1);
